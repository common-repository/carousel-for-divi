  ...
  */
  ...
  class DiviCarousel {
    ...
    public function dc_add_files() {
      ...
      wp_register_script('dc-script', plugins_url('dc-script.js', __FILE__), array('jquery'),'2.0.1', true);
      wp_enqueue_script('dc-script');

      wp_register_style('dc-style', plugins_url('dc-style.css', __FILE__), array(), '2.0.1');
